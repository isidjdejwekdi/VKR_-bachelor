...
public class PerspectiveTransformation {
    ...
    public Mat transform(Mat src, MatOfPoint2f corners) {
        ...
        //преобразование исходнодной матрицы в результирующую матрицу result
